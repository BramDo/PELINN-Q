...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--dataset", type=str, default="artifacts_csv/training_summary.npz", help="Path to NPZ dataset containing arrays X (features), Y (targets), metadata.")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    # Silence verbose Qiskit transpiler diagnostics while keeping script logs.
